    ...
    <div className="p-4 max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-4">
          <a 
            href="/FaarehaRaza_CV_Final(V1).pdf" 
            download
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <iframe
          src="/FaarehaRaza_CV_Final(V1).pdf#toolbar=0&view=FitH"
          width="100%"
          height="800px"
        ...
        >
          <p>Your browser does not support PDFs. 
            <a href="/FaarehaRaza_CV_Final(V1).pdf" className="text-blue-500 hover:underline">
              Download the resume
            </a>
          </p>
        </iframe>
      ...
      <div className="mt-4 text-sm text-gray-600">
        <p>If the resume doesn't load properly, you can <a href="/FaarehaRaza_CV_Final(V1).pdf" className="text-blue-500 hover:underline">download it here</a>.</p>
      </div>
    </div>
  );
};
